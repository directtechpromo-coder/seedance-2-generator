      ...
      <body className={inter.className} style={{ background: '#0f0a2e', margin: 0 }}>
        <nav style={{
          ...
          <div style={{ display: 'flex', gap: '4px', marginRight: '16px' }}>
            <a href="/generate" style={{ padding: '7px 14px', fontSize: '13px', fontWeight: 600, color: '#c8c0ff', borderRadius: '8px', textDecoration: 'none' }}>Generation</a>
            <a href="/gallery" style={{ padding: '7px 14px', fontSize: '13px', fontWeight: 600, color: '#c8c0ff', borderRadius: '8px', textDecoration: 'none' }}>Gallery</a>
            <a href="#pricing" style={{ padding: '7px 14px', fontSize: '13px', fontWeight: 600, color: '#c8c0ff', borderRadius: '8px', textDecoration: 'none' }}>Pricing</a>
          </div>
